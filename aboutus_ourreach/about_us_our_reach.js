 ...
 // Function to show location based on city name and change button color
 function showLocation(city, button) {
     let coords;
     let popupText;
     ...
     switch(city) {
         ...
         case 'Bardhaman':
             ...
             break;
         default:
             coords = [20.5937, 78.9629]; // Default to India
             popupText = 'India';
     }
     ...
     buttons.forEach(btn => {
         btn.classList.remove('active'); // Reset all buttons to grey
     });
     button.classList.add('active'); // Set clicked button to green
 }

 // Initial location
 showLocation('New Delhi', document.querySelector('[onclick="showLocation(\'New Delhi\', this)"]'));
